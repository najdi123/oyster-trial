...
import pic1 from "../images/hoodi/pic (1).jpg";
import pic2 from "../images/hoodi/pic (2).jpg";
import pic3 from "../images/hoodi/pic (3).jpg";
import pic4 from "../images/hoodi/pic (4).jpg";
import pic5 from "../images/hoodi/pic (5).jpg";
import pic6 from "../images/hoodi/pic (6).jpg";
import pic7 from "../images/hoodi/pic (7).jpg";
import pic8 from "../images/hoodi/pic (8).jpg";
import pic9 from "../images/hoodi/pic (9).jpg";
import pic10 from "../images/hoodi/pic (10).jpg";
import pic11 from "../images/hoodi/pic (11).jpg";
import pic12 from "../images/hoodi/pic (12).jpg";
import pic13 from "../images/hoodi/pic (13).jpg";
